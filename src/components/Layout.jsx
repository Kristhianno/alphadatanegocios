...
const TITULOS = {
  ...
  '/admin/agendamentos': 'Agendamentos ALPHADATA',
  '/admin/catalogo': 'Catálogo ALPHADATA',
  '/admin/confeitaria/pedidos': 'Pedidos ALPHADATA',
  '/admin/confeitaria/receitas': 'Receitas ALPHADATA',
  '/admin/confeitaria/estoque': 'Estoque ALPHADATA',
  '/admin/salao-festas/eventos': 'Eventos ALPHADATA',
  '/admin/salao-festas/equipe-equipamentos': 'Equipe e Equipamentos ALPHADATA',
  '/admin/fotografia/sessoes': 'Sessões ALPHADATA',
  '/admin/fotografia/producoes-video': 'Produções de Vídeo ALPHADATA',
  '/admin/fotografia/portfolio': 'Portfólio ALPHADATA',
